    ...
    <Parallax pages={5}>
      <Divider speed={0.2} offset={0}>
        ...
        <UpDownWide>
          ...
          <SVG icon="wifi" width={6} fill={colors['grey-darkest']} left="75%" top="10%" />
        ...
        <SVG icon="wifi" width={6} fill={colors['grey-darkest']} left="4%" top="20%" />
        ...
        <SVG icon="phone" width={6} fill={colors['grey-darkest']} left="10%" top="10%" />
        <SVG icon="phone" width={12} fill={colors['grey-darkest']} left="40%" top="30%" />
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <GlideInDelayed>
            <Subtitle>We develop visually appealing web and mobile applications for modern businesses.</Subtitle>
          </GlideInDelayed>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard imageSrc={lieuuLogo} title="Lieuu" link="https://lieuu.com">
              Web app to revolutionize the discovery of neighborhoods.
            </ProjectCard>
            <ProjectCard imageSrc={hcpLogo} title="Home Care Plus" link="https://homecareplusllc.com">
      ...
      <Divider speed={0.1} offset={1} factor={2}>
        ...
        <UpDownWide>
          ...
          <SVG icon="content" className={hidden} width={8} fill={colors.green} left="45%" top="10%" />
        </UpDownWide>
        ...
        <SVG icon="phone" width={12} fill={colors.yellow} left="29%" top="26%" />
      ...
      <Divider speed={0.1} offset={3}>
        <UpDown>
          ...
          <SVG icon="content" className={hidden} width={24} fill={colors.orange} left="80%" top="80%" />
        </UpDown>
        <UpDownWide>
        ...
        <SVG icon="wifi" width={6} fill={colors.white} left="4%" top="20%" />
        <SVG icon="wifi" width={12} fill={colors['grey-darkest']} left="70%" top="60%" />
        <SVG icon="code" width={6} fill={colors.orange} left="10%" top="10%" />
        <SVG icon="code" width={12} fill={colors['grey-darkest']} left="20%" top="30%" />
